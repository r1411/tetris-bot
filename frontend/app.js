...
//TODO: Вот это заменить на нормальный метод отправки JSON и получения что куда ставить
function makeJsonToSend() {
  let field = getMatrixFromGameField();
  let current_shape_name = getCurrentShape();
  jsonObject = {
    field_matrix: field,
